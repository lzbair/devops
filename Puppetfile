...
mod 'concat',
  :git => 'ssh://git@bitbucket.nespresso.com:7999/pup/puppet-concat.git',
  :ref => 'puppet-concat-1.1'
...
mod 'puppi',
  :git => 'ssh://git@bitbucket.nespresso.com:7999/xpup/puppi.git',
  :ref => 'v2.2.2'
...
mod 'sudo',
  :git => 'ssh://git@bitbucket.nespresso.com:7999/xpup/puppet-sudo.git',
  :ref => 'v2.0.19'
