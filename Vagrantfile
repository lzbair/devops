...
Vagrant.configure("2") do |config|
  ...
  config.vm.box_url = "http://nexus.nespresso.com/service/local/artifact/maven/redirect?r=nespresso-basebox&g=com.nespresso.vagrant&a=nespresso-basebox-el7&e=box&v=LATEST"
